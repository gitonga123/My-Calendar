...
<html>
    ...
    <body>
        ...
        <div class="container container-fluid">
            ...
            <form class="form-horizontal" method="post" action="/page/make/add_result" id="submitResults">
